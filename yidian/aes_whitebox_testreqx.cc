...
#include "aes_whitebox_tables_testreq_box.h"

namespace white_box_testreq
{
  using namespace white_box_table_testreq;
...
whitebox::utils::WBUint8Buf_16 white_box_testreq::cfb_encrypt(whitebox::utils::WBUint8Buf_16 &plain)
{
  whitebox::utils::WBUint8Buf_16 bufOut(plain.Size());
  white_box_testreq::aes_whitebox_encrypt_cfb((const u_int8_t *)(white_box_table_testreq::IV_VEC), (const u_int8_t *)plain.BuffPtr(), plain.Size(), bufOut.BuffPtr());
  return std::move(bufOut);
}

whitebox::utils::WBUint8Buf_16 white_box_testreq::cfb_decrypt(whitebox::utils::WBUint8Buf_16 &cyper)
{
  whitebox::utils::WBUint8Buf_16 bufOut(cyper.Size());
  white_box_testreq::aes_whitebox_decrypt_cfb((const u_int8_t *)(white_box_table_testreq::IV_VEC), (const u_int8_t *)cyper.BuffPtr(), cyper.Size(), bufOut.BuffPtr());
  return std::move(bufOut);
}
